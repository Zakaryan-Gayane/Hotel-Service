...
public class CheckIn extends ShowRoom implements ActionListener, myinterface.WriteCheckInInfo {
  ...
  public CheckIn() {
    ...
    checkIn_lbl.setForeground(Color.DARK_GRAY);
    ...
    fullName_lbl.setForeground(Color.DARK_GRAY);
    ...
    mblNum_lbl.setForeground(Color.DARK_GRAY);
    ...
    nationality_lbl.setForeground(Color.DARK_GRAY);
    ...
    gender_lbl.setForeground(Color.DARK_GRAY);
    ...
    gmail_lbl.setForeground(Color.DARK_GRAY);
    ...
    bed_lbl.setForeground(Color.DARK_GRAY);
    ...
    roomType_lbl.setForeground(Color.DARK_GRAY);
    ...
    roomNo_lbl.setForeground(Color.DARK_GRAY);
    ...
    cost_lbl.setForeground(Color.DARK_GRAY);
