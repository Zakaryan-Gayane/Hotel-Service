...
public class CheckOut extends JFrame
  ...
  public CheckOut() {
    ...
    checkOut_lbl.setForeground(Color.DARK_GRAY);
    ...
    customerNameLbl.setForeground(Color.LIGHT_GRAY);
    ...
    header.setForeground(Color.LIGHT_GRAY); // White text color for header
    ...
    checkInDate_lbl.setForeground(Color.LIGHT_GRAY);
    ...
    checkOutDate_lbl.setForeground(Color.LIGHT_GRAY);
    ...
    customerNumberLbl.setForeground(Color.LIGHT_GRAY);
    ...
    priceDay_lbl.setForeground(Color.LIGHT_GRAY);
    ...
    numberOfDays_lbl.setForeground(Color.LIGHT_GRAY);
    ...
    totalAmount_lbl.setForeground(Color.LIGHT_GRAY);
    ...
    email_lbl.setForeground(Color.LIGHT_GRAY);
    ...
    roomNum_lbl.setForeground(Color.LIGHT_GRAY);
