...
public class UCheckOut extends JFrame
  ...
  public UCheckOut() {
    ...
    custName_lbl.setForeground(Color.DARK_GRAY);
    ...
    checkInDate_lbl.setForeground(Color.DARK_GRAY);
    ...
    checkOutDate_lbl.setForeground(Color.DARK_GRAY);
    ...
    custNum_lbl.setForeground(Color.DARK_GRAY);
    ...
    priceDay_lbl.setForeground(Color.DARK_GRAY);
    ...
    numberOfDays_lbl.setForeground(Color.DARK_GRAY);
    ...
    totalAmount_lbl.setForeground(Color.DARK_GRAY);
    ...
    email_lbl.setForeground(Color.DARK_GRAY);
    ...
    roomNum_lbl.setForeground(Color.DARK_GRAY);
